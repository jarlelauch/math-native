// Math Native — app offline UI ala Obsidian (mandiri).
...
const String kAppId = 'MATH';
const String kAppName = 'Math Native';
    ...
    return ListView(padding: const EdgeInsets.all(16), children: [
      ...
      TextField(controller: c,
          decoration: const InputDecoration(
              ...
              hintText: 'v1.MATH.PRO.20270922.XXXXXX.XXXXXXXX')),
      const SizedBox(height: 8),
      FilledButton(
        onPressed: () async {
