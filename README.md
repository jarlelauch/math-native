# Math Native — Flutter (offline, UI ala Obsidian)
...
1. Repo ini sudah live di github.com/jarlelauch/math-native
...
python ../../release/prepare_vault_release.py --vault "C:/Users/realh/math-native-vault" --app MATH --out "assets/content"
flutter pub get

## Lisensi
Freemium + trial 7 hari + key PRO offline (lihat ../../licensing/license_spec.md).
Generate key: python ../../licensing/keygen.py generate --app MATH --tier PRO --exp 2027-09-22 --uid nama01
